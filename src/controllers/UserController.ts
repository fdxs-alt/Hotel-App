...
const deleteConversation = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
...
const sendMessage = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
...
const createContact = async (req: Request, res: Response, next: NextFunction): Promise<Response | void> => {
    ...
    try {
        ...
        if (alreadyExists) return next(new HttpException(400, 'You have already started conversation with the hotel'))
...
export default { deleteConversation, sendMessage, createContact, changePassword }
